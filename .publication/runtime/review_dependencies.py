...
GROUPS={
 'editorial':('contract.md','drafting.md','editorial.md','council-article.md','paragraphs.md','review.py','review_identity.py','review_dependencies.py','quote_layout.py','scripture.py'),
 'render':('conversion_review.py','quote_layout.py','scripture.py','review_dependencies.py'),
}
