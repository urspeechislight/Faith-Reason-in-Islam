...
def main():
    ...
    names=['test_review_efficiency','test_review_flow','test_article_build','test_revision_workflow','test_native_release','test_pipeline','test_scripture','test_handoff','test_quote_layout']
